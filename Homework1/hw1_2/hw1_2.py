...
def process_one_image(img_path, pattern):
    ...
    # For report
    # savename = 'outputs/a_'+pattern+'_RAW.png'
    # img_out = img * 255.0
    ...
    # # For report
    # savename = 'outputs/b_'+pattern+'_AWB.png'
    # img_out = img * 255.0
    # cv2.imwrite(savename, img_out)
    ...
    # # For report
    # savename = 'outputs/c_'+pattern+'_Demosaic.png'
    # img_out = RGB2BGR(img) * 255.0
    # cv2.imwrite(savename, img_out)
    ...
    # For report
    # savename = 'outputs/d_'+pattern+'_Color_Correction.png'
    # img_out = RGB2BGR(img) * 255.0
    # cv2.imwrite(savename, img_out)
    ...
    # For report
    # savename = 'outputs/e_'+pattern+'_XYZ2RGB.png'
    # img_out = RGB2BGR(img) * 255.0
    # cv2.imwrite(savename, img_out)
    ...
    # For report
    # savename = 'outputs/f_'+pattern+'_Tone_Mapping.png'
    # img_out = RGB2BGR(img) * 255.0
    # cv2.imwrite(savename, img_out)
